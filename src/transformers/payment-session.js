...
exports.fromCreatePaymentSessionResultDTO =
	mapProps({
		qr: fromQrDTO
	})

exports.fromPaymentSessionDTO =
	mapProps({
		expiryTime: toDate,
...
exports.toCreatePaymentSessionRequestDTO =
	mapProps({
		merchantInfo: toDynamicPayloadDTO
	})

exports.toCustomerUpdatePaymentSessionRequestDTO =
	mapProps({
		customerInfo: toDynamicPayloadDTO
	})

exports.toMerchantUpdatePaymentSessionRequestDTO =
	mapProps({
		merchantInfo: toDynamicPayloadDTO
	})
