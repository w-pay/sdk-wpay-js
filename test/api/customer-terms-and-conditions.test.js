...
const { acceptTermsAndConditionsRequest, termsAndConditionsDTO } = require("../data/terms-and-conditions");
...
describe("Terms and Conditions Apis", function () {
    ...
    describe("accept", function () {
		it("should throw error if acceptTermsAndConditionsRequest is missing", function () {
			assertThat(() => api.accept(), throws(requiredParameterError("acceptTermsAndConditionsRequest")));
		});
